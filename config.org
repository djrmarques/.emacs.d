...
** TODO Pomodoro Timer
#+begin_src emacs-lisp
  (defvar current-pomodoro-task "The name of the task for the current pomodoro")
  (defvar work-lenght-min "Number of minutes for the work length")
  (defvar interval-lenght-min "Number of minutes for the interval length")
  (defvar next-session-start "Number of minutes for the interval length")

  (defun time-to-end-session () )
